      ...
      data: [
        {
          ...
          start: new Date("2023-10-01T15:00:00.000Z"),
          end: new Date("2023-10-01T17:00:00.000Z"),
          maxInterns: 1,
        },
        {
          authorId: "demo-trainer1",
          description: "Training 2",
          start: new Date("2023-10-02T14:00:00.000Z"),
          end: new Date("2023-10-02T15:00:00.000Z"),
          maxInterns: 1,
        },
        {
          authorId: "demo-trainer1",
        ...
        },
        {
          ...
          description: "Training 1",
          start: new Date("2023-10-04T10:00:00.000Z"),
          end: new Date("2023-10-04T12:00:00.000Z"),
          maxInterns: 2,
        },
        {
          authorId: "demo-trainer2",
          description: "Training 2",
          start: new Date("2023-10-04T15:00:00.000Z"),
          end: new Date("2023-10-04T18:00:00.000Z"),
          maxInterns: 2,
        },
        {
          authorId: "demo-trainer3",
          description: "Training 1",
          start: new Date("2023-10-10T17:00:00.000Z"),
          end: new Date("2023-10-10T18:00:00.000Z"),
          maxInterns: 2,
        },
        {
          authorId: "demo-trainer3",
          description: "Training 2",
          start: new Date("2023-10-10T12:00:00.000Z"),
          end: new Date("2023-10-10T13:30:00.000Z"),
          maxInterns: 5,
        },
      ],
    });
