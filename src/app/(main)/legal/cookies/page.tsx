  ...
  return (
    <div className="py-6">
      ...
      <article className="prose">
        ...
        <ol>
          <li>
            <strong>Authentifizierungs-Cookies:</strong> Diese Cookies sind für
            die Funktion unserer Anwendung unerlässlich. Sie ermöglichen es
            Benutzern, sich sicher einzuloggen und die verschiedenen Funktionen
            unserer Anwendung zu nutzen. Diese Cookies enthalten keine
            persönlich identifizierbaren Informationen und werden nur für die
            Dauer Ihrer Sitzung gespeichert.
          </li>
          <li>
            ...
            dienen ausschließlich der Analyse und Verbesserung unserer Dienste.
          </li>
        </ol>
        <p>
        ...
        <p>
          Indem Sie unsere Anwendung nutzen, stimmen Sie der Verwendung der oben
          genannten Cookies zu. Sie haben jedoch die Möglichkeit, Cookies in
          Ihren Browsereinstellungen zu deaktivieren oder zu löschen, falls Sie
          dies bevorzugen. Bitte beachten Sie jedoch, dass dies die
