  ...
  return (
    <>
      <Breadcrumbs>
        ...
        <BreadcrumbsSeparator />
        <BreadcrumbsItem href="/legal/imprint">Impressum</BreadcrumbsItem>
      </Breadcrumbs>
      <div className="py-6">
        <div className="mb-4">
        ...
        <article className="prose">
          ...
          <p>
            ...
            verantwortlich. Solltest du dennoch auf ausgehende Links aufmerksam
            werden, welche auf eine Webseite mit rechtswidriger
            Tätigkeit/Information verweisen, ersuche ich um dementsprechenden
